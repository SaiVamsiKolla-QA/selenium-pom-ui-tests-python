...
def test_swag_info(driver, username, password):
    ...
    print("\nStep_04_Cart_Page_Checkout_Clicked.")
    Utility.capture_screenshot(driver, "Step_04_Checkout_Info_Page_Displayed.")

    # -------------------------------
    # Step 5: # Fill out the checkout information
    # -------------------------------
    info_page.enter_first_name("Vamsi")
    print("Attempting to enter first name...")
    assert info_page.enter_first_name("Vamsi"), "Failed to enter first name"
    info_page.enter_last_name("Kolla")
    assert info_page.enter_last_name("Kolla"), "Failed to enter first name"
    info_page.enter_postal_code("T6H 5J3")
    #assert info_page.enter_postal_code("T6H 5J3"),"Failed to enter first name"
    print("Step_05_Checkout_Info_Entered")
    Utility.capture_screenshot(driver, "Step_05_Checkout_Info_Entered")
    # -------------------------------
    # Step 6: # Click on the checkout button.
    # -------------------------------
    info_page.click_continue()
    Utility.capture_screenshot(driver, "Step_06_Checkout_Overview_Page_Displayed")
    #assert info_page.click_continue(), "Failed to click continue button"
    #assert overview_page.is_overview_page_displayed(), "Failed to navigate to overview page"
