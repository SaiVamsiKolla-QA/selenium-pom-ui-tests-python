...
def test_swag_info(driver, username, password):
    ...
    assert info_page.enter_postal_code("T6H 5J3"), "Failed to enter postal code"
    ...
    Utility.capture_screenshot(driver, "Step_06_error")
    ...
    # -------------------------------
    # Step 7: Click the continue button and verify navigation to overview page
    # -------------------------------
    print("\nStep_07_Checkout_Complete ")
    overview_page.click_finish()
    Utility.capture_screenshot(driver, "Step_07_Checkout_Complete")
